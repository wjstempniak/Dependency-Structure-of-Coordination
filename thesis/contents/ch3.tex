...
\input{predictions/head-initial/prague}

\input{predictions/head-initial/london}

\input{predictions/head-initial/stanford+moscow}
...
\input{predictions/head-final/template-long}
...
\input{predictions/head-final/template}

\subsection{Predykcje}

\input{predictions/head-final/A}
\input{predictions/head-final/B}
\input{predictions/head-final/C}
\input{predictions/head-final/D}
...
\input{predictions/head-final/K}
\input{predictions/head-final/L}
